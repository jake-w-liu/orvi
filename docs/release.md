...
- Version: `0.1.1` is prepared in this repo; Marketplace upload still needs the
  packaged VSIX to be uploaded from the publisher page.
...
```sh
npx --yes ovsx publish orvi-language-0.1.1.vsix -p "$OVSX_PAT"
```
